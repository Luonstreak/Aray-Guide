...
export default function Contacto(){
    ...
    return (
        <div className="bg-white flex flex-col lg:flex-row">
            <div className="w-full lg:w-1/3 lg:h-screen bg-primarylight flex flex-col justify-center items-center pt-32 pb-12">
            ...
            <div className="w-full lg:w-2/3 lg:h-screen bg-white px-4 md:px-40 py-12 lg:pt-40 lg:pb-32">
                ...
                <button type="submit" className="bg-primary text-white rounded px-4 py-2 ml-auto mt-8 w-full md:w-auto md:mx-auto">Enviar mensaje</button>
            </div>
        </div>
    )
}