...
export default function Contacto(){
    ...
    return (
        <div className="bg-white flex flex-col lg:flex-row">
            <div className="w-full lg:w-1/3 lg:h-screen bg-orange-100 flex flex-col justify-center items-center pt-32 pb-12">
                <Image src={logo} width={50} height={50} alt="logo"/>
                <h1>Contacta</h1>
                <p>con nosotros</p>
            </div>
            <div className="w-full lg:w-2/3 lg:h-screen bg-white px-4 md:px-40 py-12 lg:py-24">
                <input
                    placeholder="Nombre"
                    name="nombre" 
                    type="text" 
